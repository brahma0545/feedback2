                            ...
                            <div class="news-list">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-6 col-xs-6">
                                        ...
                                        <li>HTML CSS<a href="htmlcss&bootstrap.php"> (Syllabus)</a></li>
                                        <li>Tomcat</li></p>
                                    </div>
